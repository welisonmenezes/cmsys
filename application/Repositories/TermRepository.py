...
class TermRepository(RepositoryBase):
    ...
    def get(self, args):
        ...
        query = self.session.query(Term).filter(*fb.get_filter()).order_by(*fb.get_order_by())
    ...
    def get_by_id(self, id, args):
        ...
        result = self.get_result_by_unique_key(id, Term, self.session)
    ...
    def get_name_suggestions(self, name, args):
        ...
        return self.get_suggestions(name, Term, self.session)
    ...
    def create(self, request):
        ...
        return self.validate_before(process, Helper().get_with_slug(request.get_json(), 'name'), TermValidator, self.session)
    ...
    def update(self, id, request):
        ...
        return self.validate_before(process, Helper().get_with_slug(request.get_json(), 'name'), TermValidator, self.session, id=id)
    ...
    def delete(self, id, request):
        ...
        return self.run_if_exists(fn, Term, id, self.session)
