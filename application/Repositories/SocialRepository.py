...
class SocialRepository(RepositoryBase):
    ...
    def get(self, args):
        ...
        query = self.session.query(Social).filter(*fb.get_filter()).order_by(*fb.get_order_by())
    ...
    def get_by_id(self, id, args):
        ...
        result = self.session.query(Social).filter_by(id=id).first()
    ...
    def create(self, request):
        ...
        return self.validate_before(process, request.get_json(), SocialValidator, self.session)
    ...
    def update(self, id, request):
        ...
        return self.validate_before(process, request.get_json(), SocialValidator, self.session, id=id)
    ...
    def delete(self, id, request):
        ...
        return self.run_if_exists(fn, Social, id, self.session)
