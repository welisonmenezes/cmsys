...
class ConfigurationRepository(RepositoryBase):
    ...
    def get(self, args):
        ...
        query = self.session.query(Configuration).filter(*fb.get_filter()).order_by(*fb.get_order_by())
    ...
    def get_by_id(self, id, args):
        ...
        result = self.session.query(Configuration).filter_by(id=id).first()
    ...
    def create(self, request):
        ...
        return self.validate_before(process, request.get_json(), ConfigurationValidator, self.session)
    ...
    def update(self, id, request):
        ...
        return self.validate_before(process, request.get_json(), ConfigurationValidator, self.session, id=id)
