...
class PostRepository(RepositoryBase):
    ...
    def get(self, args):
        ...
        def run(session):
            ...
            schema = PostSchema(many=True, exclude=self.get_exclude_fields(args, ['user', 'language', 'parent', 'children', 'post_type', 'nests']))
    ...
    def get_by_id(self, id, args):
        ...
        def run(session):
            ...
            schema = PostSchema(many=False, exclude=self.get_exclude_fields(args, ['user', 'language', 'parent', 'children', 'post_type', 'nests']))
