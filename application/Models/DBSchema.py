...
class FieldSchema(ma.Schema):
    ...
    field_text = fields.Nested('FieldTextSchema', many=False)
    class Meta:
        fields = ('id', 'name', 'description', 'type', 'order', 'grouper_id', 'post_id', 'post', 'grouper', 'field_content', 'field_file', 'field_text')
...
class FieldTextSchema(ma.Schema):
    class Meta:
        fields = ('id', 'content', 'field_id', 'grouper_id', 'post_id')
