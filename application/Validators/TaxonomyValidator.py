...
from Models import Session, Taxonomy

class TaxonomyValidator(ValidatorBase):
    """Configures the Taxonomy validator to the parent class applies the validators correctly."""
