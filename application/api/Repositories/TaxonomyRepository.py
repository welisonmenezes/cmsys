...
class TaxonomyRepository(RepositoryBase):
    ...
    def get(self, args):
        ...
        query = self.session.query(Taxonomy).filter(*fb.get_filter()).order_by(*fb.get_order_by())
    ...
    def get_by_id(self, id, args):
        ...
        result = self.session.query(Taxonomy).filter_by(id=id).first()
    ...
    def create(self, request):
        ...
        return self.validate_before(process, request.get_json(), TaxonomyValidator, self.session)
    ...
    def update(self, id, request):
        ...
        return self.validate_before(process, request.get_json(), TaxonomyValidator, self.session, id=id)
    ...
    def delete(self, id, request):
        ...
        return self.run_if_exists(fn, Taxonomy, id, self.session)