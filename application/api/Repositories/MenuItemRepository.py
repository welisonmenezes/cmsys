...
class MenuItemRepository(RepositoryBase):
    ...
    def get_by_id(self, id, args):
        ...
        result = self.session.query(MenuItem).filter_by(id=id).first()
    ...
    def create(self, request):
        ...
        return self.validate_before(process, request.get_json(), MenuItemValidator, self.session)
    ...
    def update(self, id, request):
        ...
        return self.validate_before(process, request.get_json(), MenuItemValidator, self.session, id=id)
    ...
    def delete(self, id, request):
        ...
        return self.run_if_exists(fn, MenuItem, id, self.session)